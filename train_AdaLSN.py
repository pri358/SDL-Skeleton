...
parser.add_argument('--data1', default='/content/drive/MyDrive/IP - 7th sem/SK-SMALL/aug_data', type=str)
parser.add_argument('--data2', default='/content/drive/MyDrive/IP - 7th sem/SK-SMALL/aug_data/pairList.txt', type=str)
